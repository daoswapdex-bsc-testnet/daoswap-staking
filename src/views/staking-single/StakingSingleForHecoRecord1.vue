...
import {
  DAOAddress,
  DSTAddress,
  StakingSingleForHecoRecordTokenAddress1,
  StakingSingleForHecoRecordContractAddress1
} from "@/constants";
...
import StakingLimit_ABI from "@/constants/contractJson/StakingForInviterHecoRecord_abi.json";
  ...
  methods: {
    ...
    async getAccountAssets() {
      ...
      const allowance = await contractERC20DAO.methods
        .allowance(this.address, StakingSingleForHecoRecordContractAddress1)
        .call();
